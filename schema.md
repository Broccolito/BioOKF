...
| a dataset, CSV/XLSX, omics matrix, image set, knowledge base                                                              | `Dataset`            | `table`/`omics_matrix`/`image_collection`/`knowledge_base`                                                                                                          | none                                                            |
...
| an abstract score/classification/unit/ontology term                                                                       | `Concept`            | `unit`/`classification`/`ontology_term`                                                                                                                             | none                                                            |
| genuinely none of the above                                                                                               | `Other`              | none (add a `note:` saying why)                                                                                                                                     | none                                                            |
...
The positive predicate set is **24** as of v0.5 (the v0.1 to v0.4 core of 23 plus `used_to_study`),
...
4. For each biomedical entity discussed: create or update its typed concept doc, setting the
